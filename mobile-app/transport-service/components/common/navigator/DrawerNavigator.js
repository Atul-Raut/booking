...
import Map from "../../transport-service/Map";
...
import MapViewDirections from "../../transport-service/MapViewDirection";
  ...
  return (
    <Drawer.Navigator drawerContent={(props) => <DrawerContent {...props} />}>
      ...
      <Drawer.Screen
        ...
        options={({ navigation }) => ({
          header: (props) => (
            <Header navigation={navigation} name={translateMsg("CreatePost")} />
          ),
          headerLeft: null,
          headerTitleStyle: { alignSelf: "center" },
        })}
