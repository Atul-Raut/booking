...
export default class SignUpScreen2 extends AppBaseComponent {
  ...
  async onSubmit(event) {
    ...
    if (!passwordValid) {
      if (
        this.state.passwordTypeColor != "green" ||
        this.state.confirmPasswordTypeColor != "green"
      ) {
        validate = false;
        passwordInvalid = true;
        confirm_passwordInvalid = true;
        passwordValid =
          "Password's must be [7 to 15 characters which contain at least one numeric, digit and a special character]";
      }
    }
          ...
          <ScrollView>
            ...
            <View style={globalStyles.action}>
              ...
              <TextInput
                ...
                placeholder={translateMsg("emailUsername")}
                style={[
            ...
            <View style={globalStyles.action}>
              ...
              <TextInput
                ...
                style={[
                  globalStyles.textInput,
                  firstNameInvalid ? { borderColor: "red" } : {},
                ]}
                autoCapitalize="none"
                maxLength={250}
            ...
            <View style={globalStyles.action}>
              ...
              <TextInput
                ...
                style={[
                  globalStyles.textInput,
                  passwordInvalid || passwordTypeColor == "red"
                    ? { borderColor: "red", marginLeft: 10 }
                    : { marginLeft: 10 },
                ]}
                autoCapitalize="none"
            ...
            <View style={globalStyles.action}>
              <Feather
                name="lock"
                color={confirmPasswordTypeColor}
                size={20}
                style={{ marginTop: 20 }}
              />
              <TextInput
                ...
                style={[
                  globalStyles.textInput,
                  confirm_passwordInvalid || confirmPasswordTypeColor == "red"
                    ? { borderColor: "red", marginLeft: 10 }
                    : { marginLeft: 10 },
                ]}
                autoCapitalize="none"
              ...
              <TouchableOpacity
                style={[
                  globalStyles.signIn,
                  {
                    ...
                    marginTop: 15,
                    backgroundColor:
                      btnDisable || !isPrivacySelected ? "gray" : "green",
                  },
                ]}
